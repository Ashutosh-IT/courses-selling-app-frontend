...
const Signin = () => {
  ...
  const handleClick = async() => {
    ...
    if(title.current.value === "" || imgURL.current.value === "" || description.current.value === "" || price.current.value === ""){
    ...
    notifyError("Something Error Occurred");
    ...
    <div style={{
        ...
        <Paper elevation={3} sx={{
            ...
            <div style={{
                ...
                <TextField id="imageurl" label="Image URL" variant="outlined" inputRef={imgURL}/>
                <TextField id="price" label="Price" variant="outlined" inputRef={price}/>
            </div>
            <Button variant="contained" sx={{
                marginTop : "30px"
            }} onClick={handleClick}>Add Course</Button>
        </Paper>
    </div>
  )
}
